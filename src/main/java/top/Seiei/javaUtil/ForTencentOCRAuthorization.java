...
/**
 * 获取申请腾讯OCR接口，请求头中的 Authorization
 * @author Administrator
 *
 */
public class ForTencentOCRAuthorization {

	public static void main(String[] args) {
		
		long appID = 1256597016;
		String secretId = "AKIDEPPM9mvZkjW8EOuax88pZEksuodLqazG";
		String secretKey = "FNQWTFvSoCYntureJoBRXWaXO6dzdXKv";
		String bucketName = "";
		long expired = 259200L;
		
    	try {
			System.out.println(appSign(appID, secretId, secretKey, bucketName, expired));
		} catch (Exception e) {
